...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        '--url', type=str, default='https://53955.afs.twcc.ai/text-generation',
        help='url of api'
    )
    parser.add_argument(
    ...
    elif 'ffm-llama2-70b-chat-exp' in modelname:
        model = FFMLLama2(api_key = args.api_key, url = args.url)
