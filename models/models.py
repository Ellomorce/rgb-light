...
class FFMLLama2():
    def __init__(
            self, 
            api_key, 
            url="https://53955.afs.twcc.ai/text-generation", 
            model="ffm-llama2-70b-chat-exp"
            ):
    ...
    def generate(
        ...
        try:
            ...
            self.url + "/api/models/generate", json=data, headers=headers)
            if response.status_code == 200:
                result = json.loads(response.text, strict=False)['generated_text']
                with open('answer_record.json', 'w', encoding='utf-8-sig') as f:
